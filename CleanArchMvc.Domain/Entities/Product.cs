...
namespace CleanArchMvc.Domain.Entities
{
    public sealed class Product : Entity
    {
        ...
        {
            ValidadeDomain(name, description, price, stock, image, categoryId);
        }
        ...
        private void ValidadeDomain(string name, string description, decimal price, int stock, string image, int categoryId)
        {
